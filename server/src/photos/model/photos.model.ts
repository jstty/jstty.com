...
import PhotosDataStore from '../datastore/photos.datastore';

export class PhotosModel {
    private readonly logger = new Logger(PhotosModel.name);
    private photosDB;
    ...
    async getAll() {
        return await this.photosDB.getFileList();
    }

    async getTree() {
        return await this.photosDB.getTree();
    }
